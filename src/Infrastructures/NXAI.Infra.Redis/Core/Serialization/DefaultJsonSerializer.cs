...
using NXAI.Infra.Redis.Core.Internal;

namespace NXAI.Infra.Redis.Core.Serialization;
...
public class DefaultJsonSerializer : ISerializer
{
    ...
    /// The json serializer.
    /// </summary>
    private static readonly JsonSerializerOptions _jsonSerializerOption = SystemTextJson.GetNXAIDefaultOptions();
