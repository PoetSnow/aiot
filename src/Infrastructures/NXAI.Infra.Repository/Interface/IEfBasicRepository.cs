           ...
           where TEntity : Entity, IEfEntity<long>
{
    ...
    Task<TEntity?> GetAsync(long keyValue, IEnumerable<Expression<Func<TEntity, dynamic>>>? navigationPropertyPaths, bool writeDb = false, CancellationToken cancellationToken = default);
