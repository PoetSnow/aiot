...
using NXAI.Infra.Redis.Caching.Core;
using NXAI.Infra.Redis.Configurations;
using NXAI.Infra.Redis.Core.Serialization;
using NXAI.Infra.Redis.Providers.StackExchange;
using StackExchange.Redis;

namespace NXAI.Infra.Redis.Caching.Provider;
...
public partial class DefaultCachingProvider : AbstracCacheProvider, ICacheProvider
{
    ...
    private RedisKey[] SearchRedisKeys(string pattern)
    {
        ...
        foreach (var server in _servers)
        {
            ...
            // see https://github.com/dotnetcore/NXAI.Infra.Redis/pull/199 for more information
