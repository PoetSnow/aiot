...
namespace NXAI.Infra.Redis.Caching.Core.Diagnostics;

/// <summary>
/// Extension methods on the DiagnosticListener class to log NXAI.Infra.Redis
/// </summary>
public static class CachingDiagnosticListenerExtensions
{
    ...
    private const string CachingPrefix = nameof(NXAI.Infra.Redis.Caching);
