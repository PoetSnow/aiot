...
namespace NXAI.Infra.Redis.Caching.Core.Interceptor.Castle;

/// <summary>
/// caching async interceptor
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="T:NXAI.Infa.Caching.CachingAsyncInterceptor"/> class.
/// </remarks>
