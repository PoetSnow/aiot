...
/// <summary>配方步骤，表 rcp_recipe_step。禁止写死仓位号。</summary>
public class RecipeStep : EfEntity
{
    public const int Action_MaxLength = 16;
    public const int TriggerType_MaxLength = 16;
    public const int TargetKind_MaxLength = 16;
    public const int TargetCode_MaxLength = 32;
    public const int Mode_MaxLength = 16;
    public const int AmountUnit_MaxLength = 8;

    /// <summary>所属配方行。</summary>
    ...
    /// <summary>触发：TEMP_GTE / DELAY / IMMEDIATE。HEAT 用 TEMP_GTE。</summary>
    ...
    /// <summary>目标编码，如 TEA_PACK。Cooking 解析到仓位。</summary>
