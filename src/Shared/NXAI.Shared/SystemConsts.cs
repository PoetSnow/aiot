...
public static class NodeConsts
{
    ...
    public const string Cap_AppName = "Cap:AppName";
    public const string Cap_Version = "Cap:Version";
    public const string Cap_ClientProvidedName = "Cap:ClientProvidedName";
    public const string Mysql_MigrationsAssembly = "Mysql:MigrationsAssembly";
    public const string IdGenerater_WorkerName = "IdGenerater:WorkerName";
    ...
    public const string SwaggerUI_RoutePrefix = "SwaggerUI:RoutePrefix";
