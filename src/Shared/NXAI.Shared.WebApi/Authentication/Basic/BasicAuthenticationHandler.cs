...
/// </summary>
public class BasicAuthenticationHandler(IOptionsMonitor<BasicSchemeOptions> options,
    IOptions<BasicOptions> basicOptions, ILoggerFactory logger, UrlEncoder encoder)
