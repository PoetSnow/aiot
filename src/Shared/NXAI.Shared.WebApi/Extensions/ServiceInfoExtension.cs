...
public static class ServiceInfoExtension
{
    ...
    */
    ...
    public static string GetDefaultPageContent(this IServiceInfo serviceInfo, IServiceProvider serviceProvider)
    {
        ...
        var content = $"<div align='center'><a href='https://github.com/alphayu/NXAI' target='_blank'><img src='https://aspdotnetcore.net/wp-content/uploads/2023/04/NXAI-topics.png'/></a><br>" +
            ...
            $"<br><a href='{swaggerUrl}'>swagger UI</a> | <br>" +
            $"<br>{DateTime.Now}</div>";
        return content;
        //<a href='{healthCheckUrl}'>healthy checking</a>
    }
