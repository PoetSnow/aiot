...
namespace NXAI.Shared.Application.Contracts.ResultModels;
...
public sealed class ProblemDetails
{
    ...
    public override string ToString() => JsonSerializer.Serialize(this, SystemTextJson.GetNXAIDefaultOptions());
}
